...
public class Visita {
    ...
    public Visita(String name, String surname, LocalDate date, LocalTime start, LocalTime end) {
        this.name = name;
    ...
    public static Visita fromCSV(String line) {
        ...
        try {
            ...
            return new Visita(parts[0], parts[1], data, oraInizio, oraFine);
